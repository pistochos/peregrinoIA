        ...
        <footer className="footer-wrapper">
            ...
            <div className="info-wrapper">
                ...
                <div className="info-col">
                    ...
                    <a href="https://www.google.com/maps/place/Tokali,+S.A.+de+C.V./@19.2842901,-99.4458631,15.75z/data=!4m10!1m2!2m1!1stokali!3m6!1s0x85cdf5dc4148bf9b:0x35f31e0d9c86b4ba!8m2!3d19.2857724!4d-99.4381979!15sCgZ0b2thbGmSAQxtYW51ZmFjdHVyZXLgAQA!16s%2Fg%2F11sjgvg8ky?entry=ttu&g_ep=EgoyMDI0MTAyOS4wIKXMDSoASAFQAw%3D%3D" target="_blank" rel="noopener noreferrer">Callejon Viejo S/N, 52743 Río Hondito, Méx.</a>
                </div>

                <div className="info-col">
                    <a href="https://www.instagram.com/peregrino_company" target="_blank" rel="noopener noreferrer">instagram</a>
                    <a href="https://storage.net-fs.com/hosting/6464914/19/" target="_blank" rel="noopener noreferrer">Storage</a>
                    {/* <a href="https://facebook.com/" target="_blank" rel="noopener noreferrer">facebook</a>
                    <a href="https://www.tiktok.com/" target="_blank" rel="noopener noreferrer">TIKTOK</a> */}
                </div>

                <div className="info-col">
                    <p>PEREGRINO: BESPOKE LODGES</p>
